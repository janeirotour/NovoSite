...
const TX = {
  eyebrow:    { en: "What Travelers Say",                 es: "Lo Que Dicen los Viajeros",              pt: "O Que os Viajantes Dizem",               fr: "Ce Que Disent les Voyageurs",             de: "Was Reisende sagen" },
  heading:    { en: "Reviews & Testimonials",             es: "Reseñas y Testimonios",                  pt: "Avaliações e Depoimentos",               fr: "Avis et Témoignages",                     de: "Bewertungen & Testimonials" },
  ...
  findOn:     { en: "Find us on TripAdvisor",             es: "Encuéntranos en TripAdvisor",            pt: "Encontre-nos no TripAdvisor",            fr: "Retrouvez-nous sur TripAdvisor",          de: "Finden Sie uns auf TripAdvisor" },
  tripLink:   { en: "Janeiro Tour & Travel on TripAdvisor ↗", es: "Janeiro Tour & Travel en TripAdvisor ↗", pt: "Janeiro Tour & Travel no TripAdvisor ↗", fr: "Janeiro Tour & Travel sur TripAdvisor ↗", de: "Janeiro Tour & Travel auf TripAdvisor ↗" },
  excellent:  { en: "Excellent",                          es: "Excelente",                              pt: "Excelente",                              fr: "Excellent",                               de: "Ausgezeichnet" },
  guestStories:{ en: "Guest Stories",                    es: "Historias de Huéspedes",                 pt: "Histórias de Hóspedes",                  fr: "Histoires de Clients",                    de: "Gästegeschichten" },
  experiences:{ en: "Experiences Shared by Our Travelers", es: "Experiencias Compartidas por Nuestros Viajeros", pt: "Experiências Compartilhadas pelos Nossos Viajantes", fr: "Expériences Partagées par Nos Voyageurs", de: "Von unseren Reisenden geteilte Erfahrungen" },
  tripTitle:  { en: "Read All Our Reviews",              es: "Leer Todas Nuestras Reseñas",            pt: "Ler Todas as Nossas Avaliações",         fr: "Lire Tous Nos Avis",                      de: "Alle unsere Bewertungen lesen" },
  viewOn:     { en: "View on TripAdvisor",               es: "Ver en TripAdvisor",                     pt: "Ver no TripAdvisor",                     fr: "Voir sur TripAdvisor",                    de: "Auf TripAdvisor ansehen" },
  ctaTitle:   { en: "Ready to Create Your Own Story?",   es: "¿Listo para Crear Tu Propia Historia?",  pt: "Pronto para Criar a Sua Própria História?", fr: "Prêt à Créer Votre Propre Histoire ?",  de: "Bereit, Ihre eigene Geschichte zu schreiben?" },
  ctaSub:     { en: "Join thousands of satisfied travelers who discovered Brazil with us.", es: "Únete a miles de viajeros satisfechos que descubrieron Brasil con nosotros.", pt: "Junte-se a milhares de viajantes satisfeitos que descobriram o Brasil conosco.", fr: "Rejoignez des milliers de voyageurs satisfaits qui ont découvert le Brésil avec nous.", de: "Schließen Sie sich Tausenden zufriedener Reisender an, die Brasilien mit uns entdeckt haben." },
