...
const TX = {
  eyebrow:    { en: "Get In Touch",          es: "Ponte en Contacto",         pt: "Entre em Contato",           fr: "Nous Contacter",              de: "Kontakt aufnehmen" },
  heading:    { en: "Contact Janeiro Tour & Travel", es: "Contactar Janeiro Tour & Travel", pt: "Contato Janeiro Tour & Travel", fr: "Contacter Janeiro Tour & Travel", de: "Janeiro Tour & Travel kontaktieren" },
  sub:        { en: "Our team of Brazil travel experts is ready to help you plan the perfect experience.", es: "Nuestro equipo de expertos en viajes a Brasil está listo para ayudarte a planificar la experiencia perfecta.", pt: "Nossa equipe de especialistas em viagens ao Brasil está pronta para ajudá-lo a planejar a experiência perfeita.", fr: "Notre équipe d'experts en voyage au Brésil est prête à vous aider à planifier l'expérience parfaite.", de: "Unser Team von Brasilien-Reiseexperten steht Ihnen gerne zur Verfügung, um das perfekte Erlebnis zu planen." },
  howToReach: { en: "How to Reach Us",       es: "Cómo Contactarnos",         pt: "Como Nos Contatar",          fr: "Comment Nous Joindre",        de: "So erreichen Sie uns" },
  emailLabel: { en: "Email",                 es: "Correo",                    pt: "E-mail",                     fr: "E-mail",                      de: "E-Mail" },
  phoneLabel: { en: "Phone / WhatsApp",      es: "Teléfono / WhatsApp",       pt: "Telefone / WhatsApp",        fr: "Téléphone / WhatsApp",        de: "Telefon / WhatsApp" },
  basedIn:    { en: "Based In",              es: "Con Sede En",               pt: "Com Sede Em",                fr: "Basés À",                     de: "Standort" },
  chatTitle:  { en: "Chat on WhatsApp",      es: "Chatear en WhatsApp",       pt: "Conversar no WhatsApp",      fr: "Discuter sur WhatsApp",       de: "Per WhatsApp chatten" },
  chatSub:    { en: "Fastest response — available 7 days a week", es: "Respuesta más rápida — disponible los 7 días de la semana", pt: "Resposta mais rápida — disponível 7 dias por semana", fr: "Réponse la plus rapide — disponible 7 jours sur 7", de: "Schnellste Antwort — 7 Tage die Woche verfügbar" },
  openWA:     { en: "Open WhatsApp Chat",    es: "Abrir Chat de WhatsApp",    pt: "Abrir Chat no WhatsApp",     fr: "Ouvrir le Chat WhatsApp",     de: "WhatsApp-Chat öffnen" },
  certified:  { en: "Certified by the Brazilian Ministry of Tourism", es: "Certificada por el Ministerio de Turismo de Brasil", pt: "Certificada pelo Ministério do Turismo do Brasil", fr: "Certifiée par le Ministère du Tourisme du Brésil", de: "Zertifiziert vom brasilianischen Ministerium für Tourismus" },
  sendMsg:    { en: "Send Us a Message",     es: "Enviarnos un Mensaje",      pt: "Enviar uma Mensagem",        fr: "Nous Envoyer un Message",     de: "Nachricht senden" },
  fullName:   { en: "Full Name",             es: "Nombre Completo",           pt: "Nome Completo",              fr: "Nom Complet",                 de: "Vollständiger Name" },
  namePh:     { en: "Your name",             es: "Tu nombre",                 pt: "Seu nome",                   fr: "Votre nom",                   de: "Ihr Name" },
  emailAddr:  { en: "Email Address",         es: "Dirección de Correo",       pt: "Endereço de E-mail",         fr: "Adresse E-mail",              de: "E-Mail-Adresse" },
  phoneLbl:   { en: "Phone / WhatsApp (optional)", es: "Teléfono / WhatsApp (opcional)", pt: "Telefone / WhatsApp (opcional)", fr: "Téléphone / WhatsApp (facultatif)", de: "Telefon / WhatsApp (optional)" },
  msgLabel:   { en: "Your Message",          es: "Tu Mensaje",                pt: "Sua Mensagem",               fr: "Votre Message",               de: "Ihre Nachricht" },
  msgPh:      { en: "Tell us about your travel plans, dates, group size, or any questions...", es: "Cuéntanos sobre tus planes de viaje, fechas, tamaño del grupo o cualquier pregunta...", pt: "Conte-nos sobre seus planos de viagem, datas, tamanho do grupo ou qualquer dúvida...", fr: "Parlez-nous de vos projets de voyage, dates, taille du groupe ou toute question...", de: "Erzählen Sie uns von Ihren Reiseplänen, Daten, Gruppengröße oder Fragen..." },
  sendBtn:    { en: "Send Message",          es: "Enviar Mensaje",            pt: "Enviar Mensagem",            fr: "Envoyer le Message",          de: "Nachricht senden" },
  responseNote:{ en: "We respond within 24 hours, usually much sooner", es: "Respondemos en 24 horas, generalmente mucho antes", pt: "Respondemos em 24 horas, geralmente muito antes", fr: "Nous répondons dans les 24 heures, généralement bien avant", de: "Wir antworten innerhalb von 24 Stunden, meist viel früher" },
  toastTitle: { en: "Message sent!",         es: "¡Mensaje enviado!",         pt: "Mensagem enviada!",          fr: "Message envoyé !",            de: "Nachricht gesendet!" },
  toastDesc:  { en: "We'll get back to you within 24 hours.", es: "Te responderemos en 24 horas.", pt: "Responderemos em 24 horas.", fr: "Nous vous répondrons dans les 24 heures.", de: "Wir melden uns innerhalb von 24 Stunden." },
} as const;
