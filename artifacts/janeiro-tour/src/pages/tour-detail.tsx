          ...
          <div className="flex flex-wrap gap-2 mb-3">
            ...
            {tour.tourType === "private" ? (
              <Badge className="bg-accent text-accent-foreground font-semibold px-3">
                {lang === "es" ? "Tour Privado" : lang === "pt" ? "Tour Privativo" : lang === "fr" ? "Tour Privé" : lang === "de" ? "Private Tour" : lang === "no" ? "Privat tur" : "Private Tour"}
              </Badge>
            ) : (
              <Badge className="bg-white/20 text-white border border-white/40 backdrop-blur-sm font-semibold px-3">
                {lang === "es" ? "Tour Compartido" : lang === "pt" ? "Tour Compartilhado" : lang === "fr" ? "Tour Partagé" : lang === "de" ? "Gruppentour" : lang === "no" ? "Gruppetur" : "Shared Tour"}
              </Badge>
            )}
          </div>
              ...
              <div className="mt-6 flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-800">
                ...
                <p>
                  {lang === "pt"
                    ...
                    : lang === "no"
                    ? "Rekkefølgen på aktivitetene kan justeres basert på logistikk og daglige forhold, alltid med fokus på den beste opplevelsen for gruppen."
                ...
                <div className="mt-3 flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl text-sm text-blue-800">
                  ...
                  <p>
                    {lang === "pt"
                      ...
                      : lang === "no"
                      ? "Tur-retur transport er ikke inkludert, men kan legges til som tilvalg ved bestilling."
