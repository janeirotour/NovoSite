...
const TX = {
  ...
  no: {
    stat1: "Fornøyde reisende",
    stat1sub: "Fra alle verdenshjørner",
    stat2link: "Alle anmeldelser ↗",
    stat3: "År i Rio",
    stat3sub: "Grunnlagt 2014, svart eid",
    stat4: "Språk",
    stat4sub: "Engelsk · Spansk · Portugisisk",
    expEyebrow: "Kuratert for deg",
    expTitle: "Opplevelser som sitter igjen",
    expDesc: "Hver tur ledes av noen som elsker dette stedet. Det gjør forskjellen.",
    expLink: "Alle opplevelser",
    expMobile: "Se alle opplevelser",
    revEyebrow: "Hva reisende sier",
    revTitle: "Ekte mennesker. Ekte opplevelser.",
    revDesc: "Ta ikke bare vårt ord for det. Dette er historiene reisende deler etter hjemkomst.",
    revCta: "Les alle anmeldelser på Tripadvisor",
    pkgEyebrow: "Bunt og spar opptil 27%",
    pkgTitle: "Rio-opplevelsespakker",
    pkgDesc: "Tre kuraterte opplevelser, én sømløs reise — buntet til en bedre pris med transfer inkludert.",
    pkgLink: "Alle pakker",
    pkgTransfers: "Flyplasstransfer inkludert",
    pkgBook: "Se priser",
    pkgMobile: "Se alle pakker",
    beliefEyebrow: "Vår overbevisning",
    beliefQuote: '"Turisme er mer enn å besøke steder — det er å fordype seg i rik kultur, historie og de fantastiske landskapene som gjør Brasil unikt."',
    beliefYear: "siden 2014",
    exploreBtn: "Utforsk opplevelser",
    destEyebrow: "Hvor reiser du?",
    destTitle: "Seks reisemål. Hvert ett sitter igjen.",
    destDesc: "Hvert reisemål har sin egen rytme, sin egen smak, sin egen måte å ta imot deg på.",
    destLink: "Alle reisemål",
    destMobile: "Se alle reisemål",
    styleEyebrow: "Skapt for deg",
    styleTitle: "Velg din reisestil",
    styleDesc: "Alle reisende er forskjellige. Vi tilbyr to måter å utforske på — begge utformet av lokale eksperter.",
    sharedBadge: "Gruppeturer",
    sharedTitle: "Utforsk sammen",
    sharedDesc: "Bli med andre reisende i en liten gruppe. Perfekt for soloreisende og alle som ønsker å møte mennesker fra hele verden.",
    sharedLink: "Se gruppeturer",
    privateBadge: "Private turer",
    privateTitle: "Din reise, din måte",
    privateDesc: "En helt privat, skreddersydd opplevelse med en dedikert guide. Ideelt for bryllupsreiser, familieturer eller alle som vil ha et helt personlig eventyr.",
    privateLink: "Se private turer",
    ctaBadge: "Svart eid · Afroturisme · 2014",
    ctaTitle: "Din Brasil-historie begynner her.",
    ctaDesc: "Fortell oss hva du drømmer om. Vi lager reisen som gjør det virkelig — med lokalkunnskap, omsorg og ekte kjærlighet for dette landet.",
    ctaSub: "Gratis avbestilling · Ingen betaling i dag · Umiddelbar bekreftelse",
    ctaExplore: "Utforsk opplevelser",
    ctaWhatsApp: "Chat på WhatsApp",
