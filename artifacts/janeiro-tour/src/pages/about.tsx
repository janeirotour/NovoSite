...
const TX = {
  eyebrow:    { en: "Janeiro Tour & Travel",          es: "Janeiro Tour & Travel",              pt: "Janeiro Tour & Travel",              fr: "Janeiro Tour & Travel",               de: "Janeiro Tour & Travel" },
  heroTitle:  { en: "A Story Built on Passion for Brazil", es: "Una Historia Construida con Pasión por Brasil", pt: "Uma História Construída com Paixão pelo Brasil", fr: "Une Histoire Fondée sur la Passion pour le Brésil", de: "Eine Geschichte, die von Leidenschaft für Brasilien geprägt ist" },
  heroSub:    { en: "Born in Rio. Dedicated to showing the world the Brazil we love.", es: "Nacidos en Río. Dedicados a mostrar al mundo el Brasil que amamos.", pt: "Nascidos no Rio. Dedicados a mostrar ao mundo o Brasil que amamos.", fr: "Nés à Rio. Dédiés à montrer au monde le Brésil que nous aimons.", de: "In Rio geboren. Dem Ziel gewidmet, der Welt das Brasilien zu zeigen, das wir lieben." },
  founderTag: { en: "Our Founder",                    es: "Nuestra Fundadora",                  pt: "Nossa Fundadora",                    fr: "Notre Fondatrice",                    de: "Unsere Gründerin" },
  ...
  afroPioneer:{ en: "Afrotourism Pioneer",            es: "Pionera del Afroturismo",            pt: "Pioneira do Afroturismo",            fr: "Pionnière de l'Afrotourisme",         de: "Afrotourismus-Pionierin" },
  ...
  fullStory:  { en: "The Full Story",                 es: "La Historia Completa",               pt: "A História Completa",                fr: "L'Histoire Complète",                 de: "Die ganze Geschichte" },
  whyWeDo:    { en: "Why We Do What We Do",           es: "Por Qué Hacemos Lo Que Hacemos",     pt: "Por Que Fazemos O Que Fazemos",      fr: "Pourquoi Nous Faisons Ce Que Nous Faisons", de: "Warum wir tun, was wir tun" },
  ...
  afroTitle:  { en: "Rooted in Afro-Brazilian Culture", es: "Arraigados en la Cultura Afrobrasileña", pt: "Enraizados na Cultura Afro-Brasileira", fr: "Enracinés dans la Culture Afro-Brésilienne", de: "Verwurzelt in der Afro-Brasilianischen Kultur" },
  afroSub:    {
  ...
  rec3:       { en: "The motion was signed by City Councilwoman", es: "La moción fue firmada por la concejala", pt: "A moção foi assinada pela vereadora", fr: "La motion a été signée par la conseillère municipale", de: "Die Motion wurde von Stadträtin" },
  rec3b:      { en: "at the Teotônio Villela Assembly Chamber.", es: "en la Cámara de Asamblea Teotônio Villela.", pt: "na Câmara de Assembleia Teotônio Villela.", fr: "à la Chambre d'Assemblée Teotônio Villela.", de: "im Teotônio-Villela-Versammlungssaal unterzeichnet." },
  timeline:   { en: "Timeline",                        es: "Línea de Tiempo",                    pt: "Linha do Tempo",                     fr: "Chronologie",                         de: "Zeitleiste" },
  journey:    { en: "Our Journey",                     es: "Nuestro Camino",                     pt: "Nossa Jornada",                      fr: "Notre Parcours",                      de: "Unser Weg" },
  standFor:   { en: "What We Stand For",               es: "En Qué Creemos",                     pt: "No Que Acreditamos",                 fr: "Ce En Quoi Nous Croyons",             de: "Wofür wir stehen" },
  ourValues:  { en: "Our Values",                      es: "Nuestros Valores",                   pt: "Nossos Valores",                     fr: "Nos Valeurs",                         de: "Unsere Werte" },
  diff:       { en: "The Difference",                  es: "La Diferencia",                      pt: "A Diferença",                        fr: "La Différence",                       de: "Der Unterschied" },
  whyUs:      { en: "Why Travel With Us",              es: "Por Qué Viajar Con Nosotros",        pt: "Por Que Viajar Conosco",             fr: "Pourquoi Voyager Avec Nous",          de: "Warum mit uns reisen" },
  whyUsSub:   { en: "We are not a generic travel operator. We are your dedicated Brazil specialists — committed to your journey from first contact to final farewell.", es: "No somos un operador turístico genérico. Somos tus especialistas dedicados en Brasil — comprometidos con tu viaje desde el primer contacto hasta la despedida final.", pt: "Não somos um operador turístico genérico. Somos seus especialistas dedicados no Brasil — comprometidos com sua viagem do primeiro contato até a despedida final.", fr: "Nous ne sommes pas un opérateur touristique générique. Nous sommes vos spécialistes dédiés au Brésil — engagés dans votre voyage du premier contact au dernier au revoir.", de: "Wir sind kein generischer Reiseveranstalter. Wir sind Ihre dedizierten Brasilien-Spezialisten — vom ersten Kontakt bis zum letzten Abschied für Ihre Reise engagiert." },
  travelersSay:{ en: "What Travelers Say",             es: "Lo Que Dicen los Viajeros",          pt: "O Que os Viajantes Dizem",           fr: "Ce Que Disent les Voyageurs",         de: "Was Reisende sagen" },
  tripadvisor: { en: "Tripadvisor Reviews",            es: "Reseñas de Tripadvisor",             pt: "Avaliações no Tripadvisor",          fr: "Avis Tripadvisor",                    de: "Tripadvisor-Bewertungen" },
